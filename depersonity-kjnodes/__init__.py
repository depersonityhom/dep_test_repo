...
NODE_CONFIG = {
    ...
    "ImagePadForOutpaintTargetSize": {
        ...
        "name": "Image Pad For Outpaint Target Size",
    },
    ...
    "EmptyLatentImageCustomPresets": {
        ...
        "name": "Empty Latent Image Custom Presets",
    },
    ...
    "SetShakkerLabsUnionControlNetType": {
        ...
        "name": "Set Shakker Labs Union ControlNet Type",
    },
    ...
    "DifferentialDiffusionAdvanced": {
        ...
        "name": "Differential Diffusion Advanced",
    },
    ...
    "CustomControlNetWeightsFluxFromList": {
        ...
        "name": "Custom ControlNet Weights Flux From List",
    },
    ...
    "HunyuanVideoEncodeKeyframesToCond": {
        ...
        "name": "HunyuanVideo Encode Keyframes To Cond",
    },
    ...
    "StartRecordCUDAMemoryHistory": {
        ...
        "name": "Start Recording CUDAMemory History",
    },
    ...
    "ModelMemoryUsageFactorOverride": {
        ...
        "name": "Model Memory Usage Factor Override",
    },
    ...
    NODE_CONFIG.update(
        {
            ...
            "LTX2SamplingPreviewOverride": {
                ...
                "name": "LTX2 Sampling Preview Override",
            },
            "LTX2AudioLatentNormalizingSampling": {
                "class": LTX2AudioLatentNormalizingSampling,
                "name": "LTX2 Audio Latent Normalizing Sampling",
            },
            ...
            "LTX2MemoryEfficientSageAttentionPatch": {
                ...
                "name": "LTX2 Memory Efficient Sage Attention Patch",
            },
...
def generate_node_mappings(node_config):
    ...
    for node_name, node_info in node_config.items():
        updated_node_name = node_name if node_name.startswith(DEPERSONITY_PREFIX) else f"{DEPERSONITY_PREFIX}{node_name}"
        node_class = node_info["class"]

        node_class_mappings[updated_node_name] = node_class
        node_display_name_mappings[updated_node_name] = node_info.get("name", node_class.__name__)

        try:
            node_class.CATEGORY = DEPERSONITY_CATEGORY
        except Exception:
            pass
