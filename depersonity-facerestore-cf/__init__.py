...
_dep_prefix = "Depersonity_"
_dep_category = "Depersonity"

_prefixed = {}
for _k, _cls in NODE_CLASS_MAPPINGS.items():
    _prefixed[f"{_dep_prefix}{_k}"] = _cls
    try:
        _cls.CATEGORY = _dep_category
    except Exception:
        pass

NODE_CLASS_MAPPINGS.update(_prefixed)
