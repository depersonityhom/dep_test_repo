...
git clone https://github.com/depersonityhom/ComfyUI-ZMG-Nodes.git
```
...
- [ComfyUI](https://github.com/depersonityhom/ComfyUI) - 强大的AI图像生成界面
- [ComfyUI-VideoHelperSuite](https://github.com/depersonityhom/ComfyUI-VideoHelperSuite) - 视频处理参考
- [ModelScope](https://modelscope.cn/) - AI模型服务

## 📞 联系方式

- GitHub: [@fq393](https://github.com/fq393)
- 项目链接: [https://github.com/depersonityhom/ComfyUI-ZMG-Nodes](https://github.com/depersonityhom/ComfyUI-ZMG-Nodes)
