...
const NODE_TYPE = "Depersonity_TSRichNote";
const LEGACY_NODE_TYPE = "TSRichNote";
const TITLE     = "Depersonity Rich Note";
...
function isRichNoteType(nodeType) {
...
app.registerExtension({
    ...
    loadedGraphNode(node) {
        if (!isRichNoteType(node.type)) return;
        node.type = NODE_TYPE;
