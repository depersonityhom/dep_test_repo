...
**ComfyUI-Manager** is an extension designed to enhance the usability of [ComfyUI](https://github.com/depersonityhom/ComfyUI). It offers management functions to **install, remove, disable, and enable** various custom nodes of ComfyUI. Furthermore, this extension provides a hub feature and convenience functions to access a wide range of information within ComfyUI.
...
* V3.10: `double-click feature` is removed
  * This feature has been moved to https://github.com/depersonityhom/comfyui-connection-helper
...
2. `git clone https://github.com/depersonityhom/ComfyUI-Manager comfyui-manager`
3. Restart ComfyUI
...
2. Download [scripts/install-manager-for-portable-version.bat](https://github.com/depersonityhom/ComfyUI-Manager/raw/main/scripts/install-manager-for-portable-version.bat) into installed `"ComfyUI_windows_portable"` directory
...
comfy install
```
* See also: https://github.com/depersonityhom/comfy-cli
...
1. Download [scripts/install-comfyui-venv-linux.sh](https://github.com/depersonityhom/ComfyUI-Manager/raw/main/scripts/install-comfyui-venv-linux.sh) into empty install directory
- Don't click. Right-click the link and choose 'Save As...'
...
* https://github.com/depersonityhom/rfcs

**Special purpose files** (optional)
  * `pyproject.toml` - Spec file for comfyregistry.
  * `node_list.json` - When your custom nodes pattern of NODE_CLASS_MAPPINGS is not conventional, it is used to manually provide a list of nodes for reference. ([example](https://github.com/depersonityhom/comfy_mtb/raw/main/node_list.json))
...
* You can modify the `config.ini` file to apply the settings for ComfyUI-Manager.
    ...
    * See also: [https://github.com/depersonityhom/ComfyUI-Manager#paths]
...
### Example 1:
Redirecting `https://github.com/depersonityhom/ComfyUI-Impact-Pack` to `https://mirror.ghproxy.com/https://github.com/depersonityhom/ComfyUI-Impact-Pack`
...
## Credit
ComfyUI/[ComfyUI](https://github.com/depersonityhom/ComfyUI) - A powerful and modular stable diffusion GUI.
